          ...
          <div className="max-w-6xl mx-auto px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    href="https://linkedin.com/company/bumpr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-lime-400 transition-colors"
                    aria-label="LinkedIn"
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="/about" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      About Us
                    </a>
                  </li>
                  <li>
                    <a href="/practice" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      Practice Tests
                    </a>
                  </li>
                  <li>
                    <a href="/mock-test" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      Mock Tests
                    </a>
                  </li>
                  <li>
                    <a href="/results" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      Results
                    </a>
                  </li>
                </ul>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="/privacy-policy" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      Privacy Policy
                    </a>
                  </li>
                  <li>
                    <a href="/terms-conditions" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      Terms & Conditions
                    </a>
                  </li>
                  <li>
                    <a href="/refund-policy" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      Refund Policy
                    </a>
                  </li>
                  <li>
                    <a href="/disclaimer" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      Disclaimer
                    </a>
                  </li>
                </ul>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0">
                <a href="/sitemap" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                  Sitemap
                </a>
                <a href="/accessibility" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                  Accessibility
                </a>
                <a href="/cookies" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                  Cookie Policy
                </a>
              </div>
            </div>
